...
function addUser() {
    ...
    isValid &= validation.checkEmpty(fullname, "errorhoten", "(*)Tên không được bỏ trống") && validation.checkfullname(fullname, "errorhoten", "(*)Tên không được chứa số hoặc kí tự đặc biệt");
