...
function addUser() {
    ...
    isValid &= validation.checkUser(classifica, "errorclassifica", "(*)Phải chọn", "loaiNguoiDung");
    isValid &= validation.checkUser(language, "errorlanguage", "(*)Phải chọn", "loaiNgonNgu");
