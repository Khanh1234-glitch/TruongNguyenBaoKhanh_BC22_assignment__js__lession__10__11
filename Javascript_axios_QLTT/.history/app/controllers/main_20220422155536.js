...
function addUser() {
    ...
    isValid &= validation.checkEmpty(description, "errordescrip", "(*)Mô tả không được bỏ trống") && validation.checklength(description, "errordescrip", "(*)Mô tả viết nhiều nhất là 60 từ", 1, 60);
