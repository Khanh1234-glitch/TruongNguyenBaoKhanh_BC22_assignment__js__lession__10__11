...
function update(id) {
    ...
    document.getElementById("header").innerHTML = title;
    var button = `<button class='btn btn-success' onclick="updateUser(${id})">Thêm</button>`;
...
function updateUser(id) {
    ...
    var description = getEle("MoTa").value;
    // Tạo đối tượng user từ lớp đối tượng User
    var user = new User(id, account, fullname, pass, email, language, classifica, image, description);
}