...
function addUser() {
    ...
    isValid &= validation.checkEmpty(fullname, "errorhoten", "(*)Tên không được bỏ trống") && validation.checkfullname(fullname, "errorhoten", "(*)Tên không được chứa số hoặc kí tự đặc biệt và không có khoảng trắng");
    isValid &= validation.checkEmpty(pass, "errorpass", "(*)Mật khẩu không được bỏ trống") && validation.checkpassword(pass, "errorpass", "(*)Mật khẩu phải chứa ít nhất 1 chữ in hoa 1 kí tự đặc biệt 1 số và 1 chữ thường") && validation.checklength(pass, "errorpass", "(*)Mật khẩu phải dài từ 6-8 kí tự", 6, 8);
    isValid &= validation.checkEmpty(email, "erroremail", "(*)Email không được bỏ trống") && validation.checkEmail(email, "erroremail", "(*)Email không đúng định dạng");
    isValid &= validation.checkEmpty(image, "errorimg", "(*)Hình ảnh không được bỏ trống");
    isValid &= validation.checkEmpty(description, "errordescrip", "(*)Mô tả không được bỏ trống") && validation.checklength(description, "errordescrip", "(*)Mô tả viết nhiều nhất là 60 kí tự", 1, 60);
    isValid &= validation.checkOption(classifica, "errorclassifica", "(*)Phải chọn", "loaiNguoiDung");
    isValid &= validation.checkOption(language, "errorlanguage", "(*)Phải chọn", "loaiNgonNgu");
