...
function addUser() {
    ...
    isValid &= validation.checkEmpty(fullname, "errorhoten", "(*)Tên không được bỏ trống") && validation.checklengthcharacter(name, "nameTB", "(*)Vui lòng nhập chữ");
    isValid &= validation.checkEmpty(pass, "emailTB", "(*)Email không được bỏ trống") && validation.checkEmail(email, "emailTB", "(*)Vui lòng nhập đúng cú pháp email");
    isValid &= validation.checkEmpty(email, "passTB", "(*)Mật khẩu không được bỏ trống") && validation.checkpassword(pass, "passTB", "(*)Vui lòng nhập mật khẩu có ít nhất 1 kí tự số, 1 chữ viết hoa,1 chữ viết thường và 1 kí tự đặc biệt");
    isValid &= validation.checkEmpty(image, "salaryTB", "(*)Lương cơ bản không được bỏ trống") && validation.checkNumber(luongCB, "salaryTB", "(*)Vui lòng nhập số !") && validation.checkSalary(luongCB, "salaryTB", "(*)Lương cơ bản phải từ 1 triệu đến 20 triệu", 1000000, 20000000);
    isValid &= validation.checkEmpty(language, "timeTB", "(*)Giờ làm không được bỏ trống") && validation.checkNumber(gioLam, "timeTB", "(*)Vui lòng nhập số !") && validation.checkSalary(gioLam, "timeTB", "(*)Số giờ làm phải từ 80 đến 200 giờ", 80, 200);
    isValid &= validation.checkEmpty(classifica, "timeTB", "(*)Giờ làm không được bỏ trống") && validation.checkNumber(gioLam, "timeTB", "(*)Vui lòng nhập số !") && validation.checkSalary(gioLam, "timeTB", "(*)Số giờ làm phải từ 80 đến 200 giờ", 80, 200);
    isValid &= validation.checkEmpty(description, "timeTB", "(*)Giờ làm không được bỏ trống") && validation.checkNumber(gioLam, "timeTB", "(*)Vui lòng nhập số !") && validation.checkSalary(gioLam, "timeTB", "(*)Số giờ làm phải từ 80 đến 200 giờ", 80, 200);
    //check form
